...
/// Checks if no input has happened for a set amount of time and then puts the GBA in sleep mode.
...
/// Sets up graphics mode and where tiles and maps are located.
static void setupGraphics() {
	...
	REG_BG0CNT = TEXTBG_SIZE_256x256 | BG_MAP_BASE(0) | BG_TILE_BASE(2) | BG_PRIORITY(2);
